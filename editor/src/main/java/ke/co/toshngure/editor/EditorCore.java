...
import ke.co.toshngure.editor.components.DividerExtensions;
import ke.co.toshngure.editor.components.HTMLExtensions;
import ke.co.toshngure.editor.components.InputExtensions;
import ke.co.toshngure.editor.components.ListItemExtensions;
 ...
 */
    ...
    private void loadStateFromAttrs(AttributeSet attributeSet) {
        ...
        TypedArray a = null;
        try {
            a = getContext().obtainStyledAttributes(attributeSet, R.styleable.EditorCore);
            this.placeHolder = a.getString(R.styleable.EditorCore_editorPlaceholder);
            boolean editable = a.getBoolean(R.styleable.EditorCore_editorEditable, true);
            this.__renderType = editable ? RenderType.Editor : RenderType.Renderer;
